   ...
   while(listOfMenuFunctions) {
    ...
    switch(menuPhonebookSelect) {
         ...
         System.out.println("1. Type of view" + "\n" + "2. Memory Status " + "\n" + "3. Previous"); 
           ...
           int optionsSelect = input.nextInt(); 
              if(optionsSelect == 1) {
                 ...
                 System.out.println(phoneBook);
                 menuPhonebookSelect = input.nextInt();
                 }
                 break;
      case 9: 
      ...
      int callSettingsSelect = input.nextInt();
	    ...
	    else if(callSettingsSelect == 7)
	      System.out.println(settings); 
           System.out.println("Select a Settings function?"); 
           settingsSelect = input.nextInt();
	   break;
	 case 2: 
	 ...
	 break;
      case 3:
         ...
         } else if (securitySettingSelect == 7) {
	        System.out.println(settings);
	        System.out.println("Select a Settings function?"); 
             settingsSelect = input.nextInt();   
         } else {
    ...
    } else if(menuSelect == 14) {
        listOfMenuFunctions = false;
    } else
      System.out.println("Invalid input");
